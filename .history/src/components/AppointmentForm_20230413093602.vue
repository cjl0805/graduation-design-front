  ...
  <div>
    ...
    >
      ...
      <el-table :data="tableData">
        <el-table-column fixed prop="date" label="预约日期" width="200">
        </el-table-column>
        <el-table-column prop="name" label="预约时间" width="200">
        </el-table-column>
        <el-table-column prop="province" label="发型师" width="200">
        </el-table-column>
        <el-table-column prop="city" label="发型" width="200">
        </el-table-column>
