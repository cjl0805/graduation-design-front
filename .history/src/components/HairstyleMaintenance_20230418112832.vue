<template>
  <div class="div11">
    ...
    >
      <el-table-column prop="date" label="编号" style="width: 25%;align-self: center;"> </el-table-column>
      <el-table-column prop="name" label="发型名称" style="width: 25%;align-self: center;">
      </el-table-column>
      <el-table-column prop="address" label="图片" style="width: 25%;align-self: center;">
      </el-table-column>
