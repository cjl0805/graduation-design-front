<template>
    <div class="div12">
      ...
      >
        ...
        <el-table-column prop="date" label="留言时间" style="width: 25%">
        </el-table-column>
        <el-table-column prop="username" label="留言用户" style="width: 25%">
        </el-table-column>
        <el-table-column prop="content" label="留言内容" style="width: 25%">
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      deleteRow(index, rows) {
        ...
        this.axios({
          method: "DELETE",
          url: "http://localhost:8090/graduation/design/messageInfo/delete",
          data: rows[index],
        }).then((res) => {
          console.log(res.data);
          if (res.data.code === 200) {
